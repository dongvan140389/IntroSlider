package com.example.dongtv2.introslider;
...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            showHideView(R.id.btn_skip, isFirstPage ? View.GONE : View.VISIBLE);
...
//                break;
    ...
    private void showBackSlide() {
        // Checking for last page
        // If first page home screen will be launched
        int nextIndex = viewPager.getCurrentItem() - 1;
        if ((viewPager != null) && (nextIndex >= 0)) {
            viewPager.setCurrentItem(nextIndex);
        }
    }
